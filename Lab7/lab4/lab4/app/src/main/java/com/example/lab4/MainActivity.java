...
public class MainActivity extends AppCompatActivity {
    ...
    public void showUpdateDeleteDialog(final String productId, String productName) {
    ...
    private void updateProduct(String id, String nane, double price) {
        //getting the specified product reference
        DatabaseReference dR = FirebaseDatabase.getInstance().getReference("products").child(id);
        //updating product
        Product product = new Product(id, nane, price);
        dR.setValue(product);
